                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <input type="email" class="form-control-sm" id="email" name="userid"
                                        placeholder="name@domain.com" required="" value="
                                <?php
                                if (isset($_COOKIE['cuserid'])) {
                                ...
                                <div class="col-md-12 mt-4 input-group">
                                    <input type="password" id="lpassword" class="form-control" name="password"
                                        placeholder="**********" required="" pattern="^[a-zA-Z0-9]*$" value="<?php if (isset($_COOKIE['cpassword'])) {
                                ...
                                <div class="col-md-6 text-right mt-4">
                                    <label><a class="ia" href="getpassword.php" style="font-size :13px;">Forgot
                                            Password?</a></label>
                                </div>
                                ...
                                <div class="form-group col-md-12 mt-0">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <button type="submit" name="login" value="submit"
                                                class="butn-dark btn btn-block">Login</button>
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <p class="text-center m-0 ifc">Don’t you have an account? <a href="register.php"
                                            class="ia">Create Here</a></p>
                                </div>
                            </div>
                        </form>
                    </div>
